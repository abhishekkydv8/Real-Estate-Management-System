<?php
	...
	if(isset($_POST['requestBtn'])){
		...
		$query='INSERT INTO request(type,size,prize,contact,address) VALUES ("'.$type.'","'.$size.'","'.$prize.'","'.$contact.'","'.$address.'");';
